...
; SECTOR_NUM   EQU 63
;当前分区表
;    指定第一分区为主分区-活动分区 扇区数量1000个 起始扇区是从逻辑扇区20开始 ; system部分
;    指定第二分区为主分区 扇区数量10000000个 起始扇区是从逻辑扇区1024开始 
times 446 -($-$$) db 0
DISK_PARTITIONED_TABLE0:
    DPT0 db 0x80,0x00,0x14,0x00,0x0B,0x0F,0x3C,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x03,0xFC
DISK_PARTITIONED_TABLE1:
    DPT1 db 0x00,0x10,0x00,0x00,0x0B,0x6A,0x80,0x62,0x00,0x00,0x00,0x00,0x00,0x98,0x9A,0x80
